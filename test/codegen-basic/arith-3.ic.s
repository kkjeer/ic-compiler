  # Compiled by icc from test/codegen-basic/arith-3.ic
  # At Sun May 15 10:22:45 EDT 2016
...
__method_Main.main:
    ...
    movq %rsp, %rbp
    subq $0, %rsp
  # Size check: 3 >= 0						#CPP: Replaced Zero check: 3 != 0
    movq $3, %rax
    cmpq $0, %rax
  ...
  # t0 = 6
    movq $6, %rax
    movq %rax, -16(%rbp)
  # call Library.printi(6)			#CPP: Replaced call Library.printi(t0)
    movq $6, %rdi
    subq $8, %rsp
    callq __LIB_printi
    addq $8, %rsp
