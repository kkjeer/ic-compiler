  # Compiled by icc from /Users/KKjeer/workspace/ic-compiler/icc/test/codegen-basic/stmts-4.ic
  # At Fri May 13 14:28:06 EDT 2016
...
__method_Test.main:
  ...
  # label _beginWhile0
_beginWhile0:
  # t0 = true			#condition for while loop on line 5
    movq $1, %rax
    movq %rax, -32(%rbp)
  # t1 = !true
    movq $1, %rax
    ...
    movsbq %al, %rax
    movq %rax, -40(%rbp)
  # cjump t1 label _endWhile0			#test for while loop on line 5
    movq -40(%rbp), %rax
    testq %rax, %rax
    jnz _endWhile0
  # t2 = i + 1
  ...
  # call Library.printi(i)
    ...
    callq __LIB_printi
    addq $8, %rsp
  # jump label _endWhile0			#break to end of loop label _endWhile0
    jmp _endWhile0
