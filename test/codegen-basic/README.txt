...
which ones you should try to get to work first.  The order below is
the order in which they were created, by roughly increasing
complexity.

For each test, there is a file.ic file with the source code, and a
file.expected file that contains the expected output.

Use the test-runtime.py script (in icc/scripts) to automated testing.
